import { POPULAR_WHISKIES } from "./data/popular-whiskies";
import { normalize, uniqueBy } from "./text";
...
export async function suggestWhiskies(query: string): Promise<SuggestItem[]> {
  if (!query) return [];
